...
const translations = {
    en: {
        ...
        project_7_desc: "Modern bilingual website for a scientific club with dark mode, video, and 3D gallery.",
        project_8_title: "Hirafi App",
        project_8_desc: "Skills marketplace connecting skilled workers with customers. Modern UI with bilingual support.",
        project_9_title: "LeadGenius",
        project_9_desc: "Free AI-powered lead generation and email outreach tool. Find leads, generate personalized emails, automate outreach.",
        live_demo: "Live Demo",
    ...
    ar: {
        ...
        project_7_desc: "موقع ثنائي اللغة حديث لنادي علمي مع الوضع الداكن والفيديو ومعرض 3D.",
        project_8_title: "تطبيق حرفي",
        project_8_desc: "سوق للمهارات يربط العمال المهرة مع الزبائن. واجهة حديثة مع دعم ثنائي اللغة.",
        project_9_title: "LeadGenius",
        project_9_desc: "أداة مجانية للبحث عن العملاء وإرسال الإيميلات بالذكاء الاصطناعي. ابحث عن العملاء، أنشئ إيميلات مخصصة، أتمتة التواصل.",
