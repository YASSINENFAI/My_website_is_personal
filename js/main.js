...
const translations = {
    en: {
        ...
        project_7_title: "Hirafi App",
        project_7_desc: "Skills marketplace connecting skilled workers with customers. Modern UI with bilingual support.",
        project_8_title: "LeadGenius",
        project_8_desc: "Free AI-powered lead generation and email outreach tool. Find leads, generate personalized emails, automate outreach.",
        live_demo: "Live Demo",
    ...
    ar: {
        ...
        project_7_title: "تطبيق حرفي",
        project_7_desc: "سوق للمهارات يربط العمال المهرة مع الزبائن. واجهة حديثة مع دعم ثنائي اللغة.",
        project_8_title: "LeadGenius",
        project_8_desc: "أداة مجانية للبحث عن العملاء وإرسال الإيميلات بالذكاء الاصطناعي. ابحث عن العملاء، أنشئ إيميلات مخصصة، أتمتة التواصل.",
